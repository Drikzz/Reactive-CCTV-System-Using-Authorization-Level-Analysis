"""
Training script: MobileNetV3-Small transfer learning for behavior recognition

Features:
- MobileNetV3-Small pretrained on ImageNet, fully fine-tuned
...
# Project root (now two levels up since we're in mobilenetv3-small subfolder)
...
def plot_and_save(history, save_dir, model_name):
    ...
    fig.suptitle('Training Curves - MobileNetV3-Small')
    plt.tight_layout()
    ...
    with open(summary_path, 'w') as f:
        f.write('='*60 + '\n')
        f.write('TRAINING SUMMARY - TRANSFER LEARNING (MobileNetV3-Small)\n')
        f.write('='*60 + '\n')
...
def train(args):
    ...
    print('\n' + '='*60)
    print('MOBILENETV3-SMALL TRANSFER LEARNING TRAINING')
    print('='*60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train MobileNetV3-Small (transfer learning)')
    ...
    parser.add_argument('--model-name', type=str, default='mobilenet_v3_small_transfer.pth', help='Model filename')
