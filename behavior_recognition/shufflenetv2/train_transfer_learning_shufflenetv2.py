"""
Training script: ShuffleNetV2 transfer learning for behavior recognition

Features:
- ShuffleNetV2 (x1.0) pretrained on ImageNet, fully fine-tuned
...
# Project root (now two levels up since we're in shufflenetv2 subfolder)
...
def plot_and_save(history, save_dir, model_name):
    ...
    with open(summary_path, 'w') as f:
        f.write('='*60 + '\n')
        f.write('TRAINING SUMMARY - TRANSFER LEARNING (ShuffleNetV2)\n')
        f.write('='*60 + '\n')
...
def train(args):
    ...
    print('\n' + '='*60)
    print('TRANSFER LEARNING TRAINING - SHUFFLENETV2')
    print('='*60)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Train ShuffleNetV2 (transfer learning)')
    ...
    parser.add_argument('--model-name', type=str, default='shufflenet_v2_transfer.pth', help='Model filename')
